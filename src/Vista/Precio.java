...
DefaultTableModel dtm = new DefaultTableModel();
    ...
    public Precio() {
     ...
     void eliminar() {
   int fila = tblPrecio.getSelectedRow();
   dtm.removeRow(fila);
  }
    ...
    private void initComponents() {
        ...
        tblPrecio.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Productos", "Código Producto", "Precio", "Fecha alta", "Fecha baja"
            }
        ));
        tblPrecio.setName("Precio de Productos"); // NOI18N
        tblPrecio.setRequestFocusEnabled(false);
